...
const IMAGE_CARDS = [
  ...
  { src: '/images/computing-corner/cyclegan.webp',           alt: 'CycleGAN',        caption: 'A mishap of zebraification; CycleGAN detected equine features in Putin\'s face and turned him into a zebra. Unintended; technically correct.', crop: 'top',                                                                                                    link: 'https://towardsdatascience.com/translate-a-horse-to-a-zebra-cyclegan-6c3e12e40f53/' },
  { src: '/images/computing-corner/JacquardLoom.webp',       alt: 'Jacquard Loom',   caption: 'Jacquard Loom (1804); a punch-card programmable loom. Literally the first "software".',                                                                                                                                                                       link: 'https://www.scienceandindustrymuseum.org.uk/objects-and-stories/jacquard-loom' },
  { src: '/images/computing-corner/curta.webp',              alt: 'Curta Calculator', caption: 'Curta Calculator (1948); the world\'s smallest mechanical calculator. Designed at Buchenwald concentration camp by Curt Herzstark; four arithmetic functions in a fist.',                                                                                                                          link: 'https://en.wikipedia.org/wiki/Curta' },
  { src: '/images/computing-corner/neural-geometry.webp',    alt: 'Neural Geometry',  caption: 'Goodfire\'s Geometric Calculator; numbers live on circles in activation space. Each circle a different mod base; addition is Fourier decomposition in disguise.', fit: 'contain',                                                                              link: 'https://www.goodfire.ai/research/a-geometric-calculator#' },
  ...
  { src: '/images/computing-corner/curve-detector.webp',           alt: 'Curve Detector',        caption: 'Curve detector neurons in CNNs; an OpenAI finding. Early-layer units that fire for curved edges at any orientation; same neuron, any curve, any direction.',                                                                                        link: 'https://distill.pub/2020/circuits/curve-detectors/' },
  { src: '/images/computing-corner/chinese-room.webp',             alt: 'Chinese Room',          caption: 'Searle\'s Chinese Room (1980); syntax ≠ semantics. A system can manipulate symbols perfectly without understanding them; still the sharpest intuition pump against strong AI.',                                                                     link: 'https://plato.stanford.edu/entries/chinese-room/' },
  { src: '/images/computing-corner/f-pattern.webp',                alt: 'F-Pattern Eye Tracking', caption: 'How do humans read a webpage? Always in an F. Two horizontal sweeps then a vertical drop; every layout decision you\'ve ever made was predicted by this in 2006.',                                                                                               link: 'https://www.nngroup.com/articles/f-shaped-pattern-reading-web-content/' },
  { src: '/images/computing-corner/turing-pattern.webp',           alt: 'Turing Pattern',        caption: 'Turing Pattern (1952); no blueprint, no instruction. Just an activator and a faster-diffusing inhibitor; they self-organize into cheetah spots, zebra stripes, and your fingerprint ridges.',                                             link: 'https://en.wikipedia.org/wiki/Turing_pattern' },
  { src: '/images/computing-corner/induction-heads.webp',          alt: 'Induction Heads',       caption: 'Induction heads; see "A B … A", predict B. One head finds the first occurrence; one copies what followed. Likely the circuit behind most in-context learning in LLMs.', fit: 'contain', link: 'https://www.lesswrong.com/posts/TvrfY4c9eaGLeyDkE/induction-heads-illustrated' },
];
